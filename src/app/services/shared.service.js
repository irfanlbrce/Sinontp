(function () {
    ...
    function SharedService($state) {
        ...
        self.routes = [
            ...
            { id: 2, state: 'news.sinon-overcomes-barriers-to-win-grand-prize', href: '#/news/sinon-overcomes-barriers-to-win-grand-prize', name: 'SiNON Overcomes Barriers to Win Grand Prize', active: false, childContents: [], updatedDate:'2015-03-01T00:00:00+00:00',imgSrc:"" },
